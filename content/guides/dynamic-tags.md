...
| <code>&#42;&#124;ADDITIONAL_SESSION_DUE_DATE&#124;&#42;</code>     | The date by which the client has to pay for an additional session they bought. Available in the **Additional session - payment** template. See [Additional sessions](additional-sessions.md). | 31. 8. 2026 |
| <code>&#42;&#124;HAS_ADDITIONAL_SESSION_DUE_DATE&#124;&#42;</code> | Returns `1` when the additional session has a payment due date, `0` when it does not — a free additional session has none. Use with `*\|IF:HAS_ADDITIONAL_SESSION_DUE_DATE\|*` so the payment sentence disappears on free sessions instead of leaving a dangling date. | 1 |
...
| <code>&#42;&#124;EF_EXTRA_FIELD_1&#124;&#42;</code> – <code>&#42;&#124;EF_EXTRA_FIELD_15&#124;&#42;</code> | Custom fields 1–15. The number is the field's slot in **Programmes → programme → Additional Fields**, not its name — `EF_EXTRA_FIELD_2` is whatever you configured in the second slot. See [Additional fields](additional-fields.md). | Peanut allergy |
...
| <code>&#42;&#124;UPCOMING_EVENTS&#124;&#42;</code>                  | The whole personalised booking block in the session booking reminder: the client's entry-pass balance, the sessions suggested for them, and the right **Book**, **Pay** or **Buy** button. Zooza decides the content per client — you cannot influence it from the template. Available in the Upcoming Events Notification template only. |                                                       |
| <code>&#42;&#124;BOOKED_SESSIONS&#124;&#42;</code>                  | The list of sessions the client has just booked, rendered as a block. Available in the **Sessions booked** template only. |                                                       |
