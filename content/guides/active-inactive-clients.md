...
For details on service packages and pricing, see **Settings** → **Current product** in your Zooza account, or visit [Billing and Payments for Zooza](../setup/billing-and-invoicing.md).
...
- [Billing and Payments for Zooza](../setup/billing-and-invoicing.md) — managing your Zooza subscription and invoices.
