...
2. In the booking details, click on the *Add Payment* button.
 ![In the booking details, click on the Add Payment button](../../assets/images/edit-payment-on-registration-02.png)
3. Fill in the required fields and click OK
 ![Fill in the required fields and click OK](../../assets/images/edit-payment-on-registration-03.png)
...
2. In the *Payments* section, click the *Show Payments* button. This field will already appear in the list of found bookings for faster editing.
 ![In the Payments section, click the Show Payments button. This field will already appear...](../../assets/images/edit-payment-on-registration-04.png)
 ![In the Payments section, click the Show Payments button. This field will already appear...](../../assets/images/edit-payment-on-registration-05.png)
...
![For a detailed breakdown of both payments and adjustments, please refer to the List of...](../../assets/images/edit-payment-on-registration-08.png)
...
1. Manual entry - the payment was manually entered into the system directly on booking. A refund or correction does not actually return money to the client's account. It is just an adjustment in the application. The charge back must be made manually to the client from your bank account.
...
1. In the *Bookings* tab, locate the booking on which you want to edit the transaction. In the *List of Payments* section, click the *More* button next to the payment you wish to refund.
 ![In the Bookings tab, locate the booking on which you want to edit the transaction. In...](../../assets/images/edit-payment-on-registration-09.png)
2. Click *Refund payment*
 ![Click Refund payment](../../assets/images/edit-payment-on-registration-10.png)
 
3. Enter the amount to be refunded and then click OK
 ![Enter the amount to be refunded and then click OK](../../assets/images/edit-payment-on-registration-11.png)
...
1. In the *Bookings* tab, locate the booking on which you want to edit the transaction. In the *List of Payments* section, click the *More* button next to the payment you wish to refund.
 ![In the Bookings tab, locate the booking on which you want to edit the transaction. In...](../../assets/images/edit-payment-on-registration-12.png)
2. Click *Correct payment*
 ![Click Correct payment](../../assets/images/edit-payment-on-registration-13.png)
 
3. Enter the amount and then click OK
 ![Enter the amount and then click OK](../../assets/images/edit-payment-on-registration-14.png)
...
1. In the *Bookings* tab, locate the booking on which you want to edit the transaction. In the *List of Payments* section, click the *More* button next to the payment you wish to refund.
 ![In the Bookings tab, locate the booking on which you want to edit the transaction. In...](../../assets/images/edit-payment-on-registration-17.png)
2. Click *Move payment*
 ![Move payment](../../assets/images/edit-payment-on-registration-18.png)
 
3. Locate the client by name, email address, or booking number and click *Choose*.
 ![Locate the client by name, email address, or booking number and click Choose](../../assets/images/edit-payment-on-registration-19.png)
...
5. On this booking, you will see a note that the payment has been fully refunded with an option to move to the booking on which the payment is registered.
 ![On this booking, you will see a note that the payment has been fully refunded with an...](../../assets/images/edit-payment-on-registration-20.png)
...
![Once moved, you will see a note on the original booking that the payment has been...](../../assets/images/edit-payment-on-registration-22.png)
