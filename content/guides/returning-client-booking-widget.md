...
When a programme allows multiple bookings per form submission (see [Allowing multiple booking](../faq/booking-faq.md)), logged-in clients can go through the person selection step for each child separately. They can mix existing people with new ones in a single submission.
