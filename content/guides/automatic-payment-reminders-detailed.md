...
audience:
  - admin
tags: ["billing", "booking", "cancellation", "client", "communication", "location", "onboarding", "payment", "programme", "session"]
status: published
...
Next, you can choose whether to automatically delete outstanding bookings. This is recommended if you have also set up automatic payment pairing, as all functionality is evaluated on the day reminders are sent. This way, you won't automatically delete a booking that has indeed paid for a programme, but the payment has not been recorded in the app. Read more about automatic payment pairing.
...
This email is a system notification and it cannot be modified in the Communication settings. It uses dynamic tags to pull in the correct data and looks like this:
