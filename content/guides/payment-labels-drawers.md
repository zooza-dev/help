...
In **Sales & Payments → Transactions**, simply click on the colour of the payment.

![Screenshot](../../assets/images/payment-labels-drawers-01.png)

You can select the same colour-coded payments by setting the filter in **Sales & Payments → Transactions** and clicking **Search**.

![Screenshot](../../assets/images/payment-labels-drawers-02.png)
