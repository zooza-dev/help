...
2. Gradual - you don't know exactly when the dates will take place and the client pays by the number of sessions. In this case, use Pay-as-you-go programmes and create sessions on a rolling basis with ongoing payments. If the client has prepaid credit, you can record it on the booking.
