...
If you want invoices to appear directly in your accounting or ERP system, go to **Settings → Billing & Payments → Invoices** (or open `/#settings/invoice_settings`) and select your engine.
...
**Automatic** — Zooza generates an invoice every time a payment is recorded. Enable this under **Settings → Billing & Payments → Invoices → Automatic invoice generation upon payment**.
