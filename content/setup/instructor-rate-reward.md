...
![Setting the rate/reward for instuctors](../../assets/images/group-connection-02.png)
...
1. click on the *Settings *tab and select *Instructors*.
 ![click on the Settings tab and select Instructors](../../assets/images/instructor-rate-reward-02.png)
2. Then click the *Add Rate *button at the top of the screen
 ![Then click the Add Rate button at the top of the screen](../../assets/images/instructor-rate-reward-03.png)
3. Enter a title, the duration in minutes, and then click *Add*.
 ![Enter a title, the duration in minutes, and then click Add](../../assets/images/instructor-rate-reward-04.png)
...
1. click on the *Instructors *tab and select a instructor
 ![click on the Instructors tab and select a instructor](../../assets/images/instructor-rate-reward-05.png)
2. then click on the *Profile *tab
 ![then click on the Profile tab](../../assets/images/instructor-rate-reward-06.png)
3. At the bottom of the profile, click on the *Pen *icon next to the rate you want to set for the instructor and enter the value (amount). Then click the *Save *button.
 ![At the bottom of the profile, click on the Pen icon next to the rate you want to set...](../../assets/images/instructor-rate-reward-07.png)
...
![You enter the rate on the class as well as all other parameters (name, location,...](../../assets/images/instructor-rate-reward-08.png)
...
![It you already have your class created, you still have the option to add a rate to the...](../../assets/images/instructor-rate-reward-09.png)

You can decide if you want to apply the changes to all terms or only for the upcoming ones.

![You can decide if you want to apply the changes to all terms or only for the upcoming ones](../../assets/images/instructor-rate-reward-10.png)
...
1. If a term is led (substituted) by a different instructor than the one designated on the class and you want to designate a different rate for that instructor than the one designated on the class. You make this change on the term detail.
 ![If a term is led (substituted) by a different instructor than the one designated on the...](../../assets/images/instructor-rate-reward-11.png)
 ![If a term is led (substituted) by a different instructor than the one designated on the...](../../assets/images/instructor-rate-reward-12.png)
2. If a term has been cancelled and you still want to pay the instructor a remuneration. You make this change on the date detail via the compensation option. You specify the compounding of the reward as a percentage.
 ![If a term has been cancelled and you still want to pay the instructor a remuneration....](../../assets/images/instructor-rate-reward-13.png)
...
![To view the report, click Instructors, select the instructor and click the Instructors...](../../assets/images/instructor-rate-reward-15.png)
...
![Define the time period, check the option to show cancelled appointments if necessary...](../../assets/images/instructor-rate-reward-16.png)
...
![Here you can jump to the programme, class or to the required session](../../assets/images/instructor-rate-reward-18.png)
