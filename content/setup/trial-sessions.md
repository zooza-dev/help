...
![Trial sessions are a great way to show what your programmes have to offer. You will...](../../assets/images/customizing-widgets-01.png)
...
![Select Free Trial if you want to let clients attend sessions without any payment...](../../assets/images/trial-lessons-03.png)
...
![A Paid Trial allows you to charge clients a smaller, introductory fee for attending one...](../../assets/images/trial-lessons-04.png)
...
![With Lead Collection, clients can sign up for a trial session, but the exact date is...](../../assets/images/trial-lessons-06.png)
...
![To finalize the setup, enter the number of days or sessions in the Trial Length field](../../assets/images/trial-lessons-07.png)
...
3. By number of sessions - If you want to restrict the number of sessions shown, regardless of date, set a session limit. The booking form will then display only the specified number of upcoming sessions.
 ![By number of sessions - If you want to restrict the number of sessions shown,...](../../assets/images/trial-lessons-08.png)

![By number of sessions - If you want to restrict the number of sessions shown,...](../../assets/images/individual-lessons-climbing-wall-02.png)
...
![When setting up trial sessions, you can decide how session capacity is handled. Two...](../../assets/images/trial-lessons-11.png)
...
![If you select Current Available Capacity, clients can only register for a trial session...](../../assets/images/individual-lessons-climbing-wall-02.png)
...
![If you select Extra Capacity, trial participants can only be booked into the extra...](../../assets/images/individual-lessons-climbing-wall-02.png)
...
![Example: Class capacity is 10. To this is added a global extra capacity of 1 and a...](../../assets/images/customizing-widgets-01.png)
...
![Tip! You can enable trial sessions at the class level in the Settings tile under Class...](../../assets/images/trial-lessons-17.png)
...
![The information about who is coming for the trial session will be displayed directly on...](../../assets/images/trial-lessons-21.png)

![The information about who is coming for the trial session will be displayed directly on...](../../assets/images/trial-lessons-22.png)
...
![When a client signs up for a trial session, they can view it in their profile under...](../../assets/images/trial-lessons-23.png)
...
![You can review and edit all notifications in the Communication section under Message...](../../assets/images/trial-lessons-24.png)
...
![Immediately after completing the session (if attendance is recorded), the client will...](../../assets/images/trial-lessons-25.png)
...
1. In the trial booking details, click on *Enroll.
 ![In the trial booking details, click on Enroll](../../assets/images/trial-lessons-26.png)
 *
2. A window will appear with information about the class you can register the client to.
 ![A window will appear with information about the class you can register the client to](../../assets/images/trial-lessons-27.png)
3. After selecting the class, set the amount you expect to pay for booking and click Continue. If you have payment templates set up on the class, the application will automatically offer them to you and take you to the payment plan settings.
 ![After selecting the class, set the amount you expect to pay for booking and click...](../../assets/images/trial-lessons-28.png)
 ![After selecting the class, set the amount you expect to pay for booking and click...](../../assets/images/trial-lessons-29.png)
4. Check the details you have entered and confirm your booking by clicking Continue.*
 ![Check the details you have entered and confirm your booking by clicking Continue](../../assets/images/trial-lessons-30.png)
 ![Check the details you have entered and confirm your booking by clicking Continue](../../assets/images/trial-lessons-31.png)
 *
