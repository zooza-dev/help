...
![To begin using and transforming raw data from Zooza into PowerBI report, you need to...](../../assets/images/power-bi-integration-01.png)


Once activated a URL link and SAS token will be displayed. You will need both for the next step in the setup process.

![Once activated a URL link and SAS token will be displayed. You will need both for the...](../../assets/images/power-bi-integration-02.png)
...
2. Click on Get data - This opens the full list of data-source options.
 ![Click on Get data - This opens the full list of data-source options](../../assets/images/power-bi-integration-03.png)
3. Find *Azure Data Lake Storage Gen2* and click Connect
 ![Find Azure Data Lake Storage Gen2 and click Connect](../../assets/images/power-bi-integration-04.png)
4. When prompted, paste the Zooza URL provided to you in Zooza app
 ![When prompted, paste the Zooza URL provided to you in Zooza app](../../assets/images/power-bi-integration-05.png)
...
7. Back in PowerBI, paste the token you copied from Zooza (labeled as Shared access signature (SAS)) and click Connect
 ![Back in PowerBI, paste the token you copied from Zooza (labeled as Shared access...](../../assets/images/power-bi-integration-06.png)
...
2. Click Create (or Combine) if you are loading multiple files/folders to import the data immediately and begin building reports.
 ![Click Create (or Combine) if you are loading multiple files/folders to import the data...](../../assets/images/power-bi-integration-07.png)

![Click Create (or Combine) if you are loading multiple files/folders to import the data...](../../assets/images/blocks-creation-07.png)
...
![First, create a workspace to easily share your reports with colleagues. Once your Power...](../../assets/images/power-bi-integration-09.png)
...
1. To create a lakehouse, click New Item in your workspace and select Lakehouse.
 ![To create a lakehouse, click New Item in your workspace and select Lakehouse](../../assets/images/power-bi-integration-10.png)
...
1. In your workspace, click New Dataflow Gen2 on the screen.
 ![In your workspace, click New Dataflow Gen2 on the screen](../../assets/images/power-bi-integration-11.png)
2. After clicking the dataflow, go to the Home tab and click *Get Data.*
 ![After clicking the dataflow, go to the Home tab and click Get Data](../../assets/images/power-bi-integration-12.png)
3. Choose* Azure Data lake Storage Gen2* as the data source.
 ![Choose Azure Data lake Storage Gen2 as the data source](../../assets/images/power-bi-integration-13.png)
...
5. Paste the URL in the *Connection settings.*
 ![Paste the URL in the Connection settings](../../assets/images/power-bi-integration-14.png)
6. In *Connection Credentials* change the *Authentication kind* to* Shared Access Signature (SAS).*
 ![In Connection Credentials change the Authentication kind to Shared Access Signature (SAS)](../../assets/images/power-bi-integration-15.png)
7. Copy the SAS token from Zooza and paste it to the SAS token field and click Next.
 ![Copy the SAS token from Zooza and paste it to the SAS token field and click Next](../../assets/images/power-bi-integration-16.png)
8. If the connection is successful you will see a preview of folder data that needs to be combined together into a data model. Detailed information about the structure and meaning of Zooza’s data can be found in manual [Power BI Data description](../guides/power-bi-data-description.md)*. *You can add as many tables as you need to your Dataflow and transform them with Power Query.*
 ![If the connection is successful you will see a preview of folder data that needs to be...](../../assets/images/power-bi-integration-17.png)
 *
...
11. View the* Data Destination*, where you will see that the data is being saved to the Lakehouse. If your Lakehouse is not visible as a destination, click the plus (+) icon to manually assign it.
 ![View the Data Destination, where you will see that the data is being saved to the...](../../assets/images/power-bi-integration-18.png)
12. Click *Publish *to save your data model into a* SQL Semantic Model*, which will serve as the foundation for visualizing your data. Once the semantic model is published and refreshed, you can continue editing the data model by navigating to the lakehouse folder and clicking on the *SQL analytics endpoint.* From there, you can connect, merge, append tables or create calculations using or DAX.
 ![Click Publish to save your data model into a SQL Semantic Model, which will serve as...](../../assets/images/power-bi-integration-19.png)
...
![If no further changes are needed, go to the Reporting tab and click New Report to begin...](../../assets/images/power-bi-integration-20.png)
