...
Payments that arrived before the change stay in the account they were paired to. Open that account's **Sales & Payments → Transactions**, export the list, and pair them manually in the correct account from **Sales & Payments → Payment reconciliation**.
