...
![Search for the keyword Zooza and then click the Activate button next to the plugin you...](../../assets/images/deploying-zooza-on-website-01.png)
- In the Settings tab, click on *Zooza*
- Fill in the required fields and follow the written procedure

![Fill in the required fields and follow the written procedure](../../assets/images/deploying-zooza-on-website-02.png)
- API and Secret Key can be found in the *Publish *section

![API and Secret Key can be found in the Publish section](../../assets/images/deploying-zooza-on-website-03.png)
...
![In the booking forms, select the subpages you have created for this purpose. You will...](../../assets/images/deploying-zooza-on-website-04.png)

![In the booking forms, select the subpages you have created for this purpose. You will...](../../assets/images/discount-code-07.png)
...
1. In the *Publish *section, select the *Embed *integration type*
 ![In the Publish section, select the Embed integration type](../../assets/images/deploying-zooza-on-website-06.png)
 *
2. This will open a menu of widgets that you can integrate. Click on one of them to open the HTML script
 ![This will open a menu of widgets that you can integrate. Click on one of them to open...](../../assets/images/deploying-zooza-on-website-07.png)

![This will open a menu of widgets that you can integrate. Click on one of them to open...](../../assets/images/customizing-widgets-01.png)
...
![If you have a page built around a specific programme offering, Zooza allows you to...](../../assets/images/blocks-creation-07.png)
...
![If you collect a lot of additional data in the booking form or use products, you can...](../../assets/images/deploying-zooza-on-website-10.png)

![If you collect a lot of additional data in the booking form or use products, you can...](../../assets/images/blocks-creation-14.png)
