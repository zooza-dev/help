...
- `content/guides/sending-email-sms.md` — references `../../assets/images/sending-approval-gate.png "Approval gate for bulk sends"`
- `content/guides/sending-email-sms.md` — references `../../assets/images/sending-progress-view.png "Bulk send progress view"`
