...
**URL:** https://support.zooza.online/portal/en/kb/articles/new-course-existing-clients
...
You can find the procedure how to copy groups, terms and registrations 
...
If you need to move a client to a group and want to keep the payment or credit details, you need to use the 
