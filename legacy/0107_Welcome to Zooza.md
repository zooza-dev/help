...
**URL:** https://support.zooza.online/portal/en/kb/articles/network-application
...
Define and manage the list of companies included in the network

Standardize and assign product codes that unify course tracking across the network

Monitor the progress and performance of courses and offerings throughout all franchise branches
...
Companies Mode: Metrics are aggregated by individual franchise companies.

Places Mode: Metrics are aggregated by franchise locations (places)
...
Fixed Period that has not started yet

Fixed Period that is ongoing
...
Note:
 ...
 Early in a new period, you may see only a few New Enrollments, but the total Enrollments remains high due to ongoing registrations from earlier periods.
...
Note:
 ...
 The value can occasionally be negative if the sum of corrections on a given day exceeds newly received payments.
